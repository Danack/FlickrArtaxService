...
class flickrTestLogin implements \ArtaxServiceBuilder\Operation {
    ...
    public function __construct(\FlickrService\FlickrAPI\FlickrAPI $api, $api_key) {
        $defaultParams = [
            'format' => 'json',
            'nojsoncallback' => '1',
     ...
     *
     * @return \FlickrService\Model\LoginInfo
     ...
     *
     * @return mixed|\FlickrService\Model\LoginInfo
     */
    public function call() {
        ...
        if ($this->shouldResponseBeProcessed($response)) {
            $instance = \FlickrService\Model\LoginInfo::createFromResponse($response, $this);
