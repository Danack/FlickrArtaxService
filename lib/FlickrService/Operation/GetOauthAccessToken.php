...
class GetOauthAccessToken implements \ArtaxServiceBuilder\Operation {
    ...
    public function __construct(\FlickrService\FlickrAPI\FlickrAPI $api, $oauth_verifier) {
        $this->api = $api;
     ...
     *
     * @return \FlickrService\Model\OauthAccessToken
     ...
     *
     * @return mixed|\FlickrService\Model\OauthAccessToken
     */
    public function call() {
        ...
        if ($this->shouldResponseBeProcessed($response)) {
            $instance = \FlickrService\Model\OauthAccessToken::createFromResponse($response, $this);
