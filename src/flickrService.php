...
// 1
		"flickr.activity.userComments" => array(
			...
			'needsSigning' => true,
			'responseClass' => 'FlickrGuzzle\\Model\\ActivityInfo',
			'parameters' => array(
				'per_page'    => array(
					'location' => 'query',
...
// 7
		"flickr.auth.oauth.checkToken" => array(
			...
			'needsSigning' => true,
			'responseClass' => 'FlickrGuzzle\\Model\\OauthCheck',
			'parameters' => array(
				'oauth_token'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
...
//			'needsSigning' => true,
//			'responseClass' => null, //'FlickrGuzzle\\Model\\',
//			/* Example
//<auth>
...
// 9
		"flickr.blogs.getList" => array(
			...
			'needsSigning' => true,
			'responseClass' => 'FlickrGuzzle\\Model\\UserBlogList',
...
// 10
		"flickr.blogs.getServices" => array(
			...
			'responseClass' => "FlickrGuzzle\\Model\\BlogServiceList",
			'parameters' => array(
				'method'    => array(
					'location' => 'query',
					'description' => 'Which flickr call is being made.',
...
// 11
		"flickr.blogs.postPhoto" => array(
			...
			'needsSigning' => true,
			'responseClass' => 'FlickrGuzzle\\Model\\GenericResponse',
			'parameters' => array(
				'blog_id'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
...
// 12
		"flickr.cameras.getBrandModels" => array(
			...
			"responseClass" => "FlickrGuzzle\\Model\\CameraDetailList",
			'parameters' => array(
				'brand'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
...
// 13
		"flickr.cameras.getBrands" => array(
			...
			"responseClass" => "FlickrGuzzle\\Model\\CameraBrandList",
			'parameters' => array(
				'method'    => array(
					'location' => 'query',
					'description' => 'Which flickr call is being made.',
...
// 16
		"flickr.commons.getInstitutions" => array(
			...
			'responseClass' => "FlickrGuzzle\\Model\\InstitutionList",
			'parameters' => array(
				'method'    => array(
					'location' => 'query',
					'description' => 'Which flickr call is being made.',
...
// 17
		"flickr.contacts.getList" => array(
			...
			'needsSigning' => true,
			'responseClass' => 'FlickrGuzzle\\Model\\UserList',
			/* Example
...
// 23
		"flickr.favorites.getList" => array(
			...
			'needsSigning' => true,
			"responseClass" => "FlickrGuzzle\\Model\\PhotoList",
			'parameters' => array(
				'user_id'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
...
// 63
		"flickr.people.findByEmail" => array(
			...
			'responseClass' => 'FlickrGuzzle\\Model\\LookupUser',
			'parameters' => array(
				'find_email'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
...
// 96
		"flickr.photos.getInfo" => array(
			...
			"responseClass" => "FlickrGuzzle\\Model\\PhotoInfo",
			'parameters' => array(
				'photo_id'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
...
// 104
		"flickr.photos.licenses.getInfo" => array(
			...
			'responseClass' => "FlickrGuzzle\\Model\\LicenseList",
			'parameters' => array(
				'method'    => array(
					'location' => 'query',
					'description' => 'Which flickr call is being made.',
...
// 106
		"flickr.photos.notes.add" => array(
			...
			'needsSigning' => true,
			'responseClass' => 'FlickrGuzzle\\Model\\NoteID',
...
// 128
		"flickr.photos.transform.rotate" => array(
			...
			'needsSigning' => true,
			'responseClass' => 'FlickrGuzzle\\Model\\PhotoInfoTransform',
			/* Example
<photoid secret="abcdef" originalsecret="abcdef">1234</photoid>
*/
			'parameters' => array(
...
The flickr.places.find method is <b>not</b> a geocoder. It will round <q>up</q> to the nearest place type to which place IDs apply. For example, if you pass it a street level address it will return the city that contains the address rather than the street, or building, itself.',
			'responseClass' => 'FlickrGuzzle\\Model\\PlaceList',
			'parameters' => array(
				'query'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
...
// 172
		"flickr.reflection.getMethodInfo" => array(
			...
			"responseClass" => "FlickrGuzzle\\Model\\MethodInfo",
			'parameters' => array(
				'method_name'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
...
// 173
		"flickr.reflection.getMethods" => array(
			...
			"responseClass" => "FlickrGuzzle\\Model\\MethodList",
			'parameters' => array(
				'method'    => array(
					'location' => 'query',
					'description' => 'Which flickr call is being made.',
...
// 188
		"flickr.stats.getTotalViews" => array(
			...
			'needsSigning' => true,
			'responseClass' => 'FlickrGuzzle\\Model\\AccountStat',
			'parameters' => array(
				'date'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
...
// 191
		"flickr.tags.getHotList" => array(
			...
			'responseClass' => 'FlickrGuzzle\\Model\\TagList',
			'parameters' => array(
				'period'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
...
//// 199
		"flickr.test.login" => array(
			...
			'needsSigning' => true,
			'responseClass' => 'AABTest\LoginInfo', //'FlickrGuzzle\\Model\\',
			'parameters' => array(
                'method'    => array(
					'location' => 'query',
					'description' => 'Which flickr call is being made.',
...
// 201
		"flickr.urls.getGroup" => array(
			...
			'responseClass' => 'FlickrGuzzle\\Model\\URLInfo',
			'parameters' => array(
				'group_id'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
...
// 204
		"flickr.urls.lookupGallery" => array(
			...
			'responseClass' => 'FlickrGuzzle\\Model\\LookupGallery',
			'parameters' => array(
				'url'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
...
// 205
		"flickr.urls.lookupGroup" => array(
			...
			'responseClass' => 'FlickrGuzzle\\Model\\LookupGroup',
			'parameters' => array(
				'url'    => array(
					'location' => 'query',
					'description' => 'todo - describe variable',
